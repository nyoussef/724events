...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // il n'y avait pas de paramètre entre les parenthèses
    setValue(newValue);
    setCollapsed(true); // setCollapsed attendait plutôt comme paramètre "true" afin de lui dire de fermer le menu déroulant après qu'un élément de la liste ai été sélectionné
  };
  return (
